...
const ActionPanel: React.FunctionComponent<ActionPanelProps> = ({
  ...
  const { quoteToken, token, canharvest } = farm
  ...
  //   ? `https://pancakeswap.info/tokens/${lpAddress}`
  //   : `https://pancakeswap.info/pool/${lpAddress}`
  const addLiquidityUrl = farm.isTokenOnly
    ? `${BASE_URL}/swap?outputCurrency=${getAddress(farm.token.address)}`
  ...
  return (
    <Container expanded={expanded}>
      <InfoContainer>
        ...
        <StyledLinkExternal color="text" href={bsc}>
          {t('View Contract')}
        </StyledLinkExternal>
