...
import { Heading, RowType, Toggle, Text, Flex } from '@pancakeswap/uikit'
      ...
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        const { cakeRewardsApr, lpRewardsApr } = isActive
          ? getFarmApr(
              ...
              new BigNumber(farm.miaperblock),
            )
            ...
            <Flex flexDirection="column" flex="1" alignSelf={['flex-start', null, null, 'center']}>
              ...
              <Flex>
                <Heading scale="lg" color="text">
                  {tokenMode ? t('Stake Single token to earn MIA,') : t('Stake LP tokens to earn MIA,')}
                </Heading>
                <Text ml="10px" fontSize="18px">
                  {t('Deposit Fee will be used to buyback MIA')}
                </Text>
              </Flex>
            </Flex>
