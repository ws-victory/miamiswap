...
export const MIA: { [chainId: number]: Token } = {
  [ChainId.MAINNET]: new Token(
    ChainId.MAINNET,
    '0x5417f8559ee78f0E77589109d605246c89Dd01c9',
    9,
    'MIA',
    'Miami Token',
  ),
...
const tokens = {
  ...
  mia: {
    symbol: 'MIA',
    address: {
      56: '0x5417f8559ee78f0E77589109d605246c89Dd01c9',
      97: '',
    },
    decimals: 9,
    projectLink: 'https://miamiswap.finance/'
  },
  scan: {
    symbol: 'SCAN',
    address: {
      56: '0xCCcE542413528CB57B5761e061F4683A1247aDCB',
      97: '',
    },
    decimals: 9,
    projectLink: 'https://scandefi.net/'
  },
  babycake: {
    symbol: 'BABYCAKE',
    address: {
  ...
  yae: {
    symbol: 'YAE',
    address: {
      56: '0x4eE438be38F8682ABB089F2BFeA48851C5E71EAF',
      97: '',
    },
    decimals: 18,
    projectLink: 'https://cryptonovae.com/',
  },
  bmon: {
    symbol: 'BMON',
    address: {
